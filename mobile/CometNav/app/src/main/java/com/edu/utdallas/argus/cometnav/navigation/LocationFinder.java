...
public class LocationFinder
{
     ...
     */
    public static double[] getLocationPoint(double[][] positions, double[] distances)
    {
    ...
    private static void testResults(double[] expectedPosition, final double delta, LeastSquaresOptimizer.Optimum optimum, RealVector x) {
    ...
    public static void trilateration1DExact1() throws Exception {
    ...
    public static void trilateration2DExact1() throws Exception {
    ...
    public static void trilateration3DExact() throws Exception {
        //double[][] positions = new double[][] { { 1.0, 1.0, 1.0 }, { 3.0, 1.0, 1.0 }, { 2.0, 2.0, 1.0 } };
        double[][] positions = new double[][] { { 0, 0, 0 }, { 1, 0, 0 }};
        ...
        double[] expectedPosition = new double[] { 0.5, 0, 0 };
        RealVector x = lSolver.solve();
        Optimum optimum = nlSolver.solve();
        testResults(expectedPosition, 0.0001, optimum, x);
    }

    public static void trilateration3DInexact() throws Exception {
    ...
    public static void trilateration2DInexact1() throws Exception {
        double[][] positions = new double[][] { { 1.0, 1.0 }, { 3.0, 1.0 }, { 2.0, 2.0 } };
    ...
    public static void trilateration2DExact3() throws Exception {
    ...
    /* Usage below (from github website
